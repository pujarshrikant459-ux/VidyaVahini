  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        <section className="relative w-full h-[60vh] text-white">
          ...
          <div className="relative z-20 container mx-auto flex flex-col items-center justify-center h-full text-center px-4">
            <h2 className="text-4xl md:text-6xl font-bold font-headline mb-4">VidyaSetu: Bridge of Education</h2>
        ...
        <section id="about" className="py-16 bg-background">
          <div className="container mx-auto px-4 text-center">
            <h3 className="text-3xl font-bold font-headline mb-4">About VidyaSetu</h3>
      ...
      <footer className="bg-primary text-primary-foreground py-6">
        <div className="container mx-auto flex justify-between items-center">
          <p>&copy; {new Date().getFullYear()} VidyaSetu. All Rights Reserved.</p>
